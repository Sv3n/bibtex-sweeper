...
class BibTexSweeperConfig(object):
    ...
    def load(cfgFile):
        with open(cfgFile, 'r') as f:
            ...
            BibTexSweeperConfig.replace         = config.get('replace', BibTexSweeperConfig.replace)
            BibTexSweeperConfig.typeAliases     = config.get('typeAliases', BibTexSweeperConfig.typeAliases)
            BibTexSweeperConfig.outputElements  = config.get('outputElements', BibTexSweeperConfig.outputElements)
            BibTexSweeperConfig.protectStrings  = config.get('protectStrings', BibTexSweeperConfig.protectStrings)
            BibTexSweeperConfig.etAlTreshold    = config.get('etAlTreshold', BibTexSweeperConfig.etAlTreshold)
            BibTexSweeperConfig.protectElements = config.get('protectElements', BibTexSweeperConfig.protectElements)

            """ Make sure we never filter out the 'type' and 'id' """
            for bibType, allowedElements in BibTexSweeperConfig.outputElements.items():
                allowedElements.extend(BibTexSweeperConfig.baseOutputElements)
